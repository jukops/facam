resource "aws_iam_role" "eks_aws_lb_controller" {
  name = "eks-aws_lb_controller"
...
resource "aws_iam_role_policy" "eks_aws_lb_controller" {
  name = "AllowPermissons"
  role = aws_iam_role.eks_aws_lb_controller.id
  policy = <<EOF
{
    "Version": "2012-10-17",
    "Statement": [
